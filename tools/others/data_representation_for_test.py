...
def calculate_gemini_features(mapping_data):
    ...
    for k in tqdm(keys, total=len(keys)):
        ...
        # mapping_data[k]["geminimol_graph"] = graph.cpu().detach()
    return mapping_data
...
def calcaulte_unimol_features(mapping_data):
    ...
    # unimol_repr = clf.get_repr(data_cover, return_atomic_reprs=True)
    ...
    for idx, key in enumerate(keys):
        ...
        # mapping_data[key]["unimol_coords"] = unimol_coords[idx]
